...
int mqtt_init() {
    ...
    struct credentials_t credentials = {
        .username = "xlorin01@stud.fit.vutbr.cz",
        .authentication = auth
    };
    esp_mqtt_client_config_t mqtt_cfg = {
            .broker.address.uri = "mqtt://147.229.12.176:1883",
...
int mqtt_send_data(const char* data, int length) {
    return esp_mqtt_client_enqueue(client, "v1/devices/me/xlorin01/telemetry", data, length, 1, 0, 1);
}